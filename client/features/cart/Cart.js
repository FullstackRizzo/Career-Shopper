...
import {
  addToOrderQuantityAsync,
  deleteGuestOrderAsync,
  fetchGuestOrderAsync,
  fetchUserOrderAsync,
  selectCart,
  subtractFromOrderQuantityAsync,
} from "./cartSlice";
            ...
            {order.map((order) => (
              <div key={order.career.id}>
                ...
                <button
                  onClick={(e) => {
                    e.preventDefault;
                    subtractFromOrderQuantity(order.career.id);
                  }}
                >
                  -
                </button>
                ...
                <button
                  onClick={(e) => {
                    e.preventDefault;
                    addToOrderQuantity(order.career.id);
                  }}
                >
                  +
                </button>
