...
const products = await Promise.all([
  ...
  Product.create({ name: 'Marketing Manager', 
                   salary: 137000, 
                   timeOfCompletion: 4, 
  ...
  Product.create({ name: 'Psychologist', 
                   salary: 79000, 
                   timeOfCompletion: 8, 
  ...
  Product.create({ name: 'Electrician', 
                   salary: 56000, 
                   timeOfCompletion: 4, 
